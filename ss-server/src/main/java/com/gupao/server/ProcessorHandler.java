...
public class ProcessorHandler implements Runnable{
    ...
    Map<String,Object> handlerMap;// 现在需要从map里获取需要发布的绑定服务<br>    //<code class="java keyword">private</code> <code class="java plain">Object service; </code><code class="java comments">// 原来的代码，服务端发布的服务</code>
